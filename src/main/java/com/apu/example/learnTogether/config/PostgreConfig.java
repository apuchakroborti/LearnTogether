package com.apu.example.learnTogether.config;
...
@EnableJpaRepositories(
        ...
        basePackages = {"com.apu.example.learnTogether.repository"}
)
public class PostgreConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(@Qualifier("primaryDataSource") DataSource dataSource) {
        ...
        em.setPackagesToScan("com.apu.example.learnTogether.models");
